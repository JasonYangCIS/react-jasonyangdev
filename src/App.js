       ...
       <section id="four">
          ...
          <div className="experience-card">
            ...
            <p className="experience">
              ...
              <i className="fa fa-angle-right"></i> Also used this as an opportunity to enhance my DevOps experience. Setup NPM DPLOY to enhance efficiency and deployment of code changes.<br/>
